...
public class SQLiteManager extends SQLiteOpenHelper {
    ...
    public SQLiteManager(Context context, String name,
        ...
        System.out.println(context.getDatabasePath("data.db").toString());
    }
    @Override
    public void onCreate(SQLiteDatabase db) {
        // TODO Auto-generated method stub
        // SQLiteOpenHelper 가 최초 실행 되었을 때
        String sql = "create table attend (" +
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        String sql = "drop table if exists attend";
        db.execSQL(sql);
